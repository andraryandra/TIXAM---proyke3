...
@section('breadcrumb')
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ url('/master/kelas') }}">Mata Pelajaran</a></li>
...
<div class="col-md-9">
  <div class="box box-primary">
      ...
      <h3 class="box-title">{{ $mapel->nama }}</h3>
      <div class="pull-right">
        <a href="{{ url('master/mapel/ubah/'.$mapel->id) }}" class="btn btn-success" id="btn-create"><i class="fa fa-edit"></i> Tambah Siswa</a>
        <a href="{{ url('master/mapel/ubah/'.$mapel->id) }}" class="btn btn-primary" id="btn-create"><i class="fa fa-edit"></i> Ubah Kelas</a>
