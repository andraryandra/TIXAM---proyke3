...
<?php include(app_path() . '/functions/myconf.php'); ?>
  <div class="col-md-8">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title aaaa"><i class="fa fa-address-card" aria-hidden="true"></i> Data Mata Pelajaran</h3>
        <div class="pull-right">
          <button type="button" class="btn btn-primary" id="btn-create"><i class="fa fa-edit"></i> Buat Mata Pelajaran</button>
        </div>
      </div>
      <div class="box-body">
        <div class="col-sm-12">
            ...
            <form id="form-kelas" style="display: none; margin: 0 auto 20px;" class="form-horizontal well">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="email" class="form-control" name="nama" id="nama" placeholder="Nama Mata Pelajaran">
                </div>
              </div>
              <div class="form-group">
  ...
  <div class="col-md-4">
    <div class="box box-warning">
      ...
      <!-- <div class="box-body">
        <p>Daftarkan seluruh mata pelajaran malalui halaman ini. Data kelas diperlukan untuk mengelompokan siswa dan untuk mendistribusian paket soal.</p>
